                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="bradcaump__inner text-center">
                        	<h2 class="bradcaump-title">Coming Soon</h2>
        ...
        <div class="container">
            <div class="row">
                <div class="col-4 mt-5">
                        <img src="<?=base_url('assets/images/bg/images.jpg')?>" alt="" srcset="">
                </div>
                <div class="col-6 mt-5">
                    <h2 style="color:#B97C5E;">Buy Your Ticket Here </h2> <br>
                    <h4>Weekday</h4>
                    <p>Open in 08.00 AM - 04.00 PM</p> <br>
                    <h4>Weekend</h4>
                    <p>Open in 07.00 AM - 05.00 PM</p> <br>
                    <a class="txt2" style="background-color:#B97C5E; color:white; font-family:sans-serif; font-size:15px; border-radius:25%; border:0px;">Book Ticket</button>
